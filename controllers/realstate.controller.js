const realStateModel = require("../models/realState.model");
...
exports.resizeImage = asyncHandler((req, res, next) => {
  ...
  sharp(req.file.buffer)
    ...
    .toFormat("jpeg")
    .jpeg({ quality: 90 })
    .toFile(`uploads/products/realstates/${filename}`);
...
exports.getAllRealState = factory.getAll(realStateModel);

// @desc Get specific car by id
// @route GET /api/v1/car/:id
// @access Public

exports.getRealState = factory.getOne(realStateModel);
...
exports.createRealState = factory.createOne(realStateModel);

// @desc Update specific RealState
// @route PUT /api/v1/RealState/:id
// @access Private

exports.updateRealState = factory.updateOne(realStateModel);

// @desc Delete specific RealState
// @route DELETE /api/v1/RealState/:id
// @access Private

exports.deleteRealState = factory.deleteOne(realStateModel);

// exports.deleteRealState = asyncHandler(async (req, res, next) => {
